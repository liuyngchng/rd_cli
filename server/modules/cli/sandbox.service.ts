...
Subcommands:
  ...
  ${terminalTextStyles.bright('logs')}         Show rdCLI server logs
    ...
    async execute(argumentsList) {
      ...
      switch (options.subcommand) {
        ...
        case 'start': {
          ...
          dependencies.output.log(`${terminalTextStyles.info('▶')} Launching rdCLI web server...`);
          dependencies.runSandboxCommand([
            'exec',
            sandboxName,
            'bash',
          ...
          dependencies.output.log(`\n${terminalTextStyles.ok('✔')} ${terminalTextStyles.bright('rdCLI is ready!')}`);
        ...
        case 'create': {
          ...
          dependencies.output.log(`\n${terminalTextStyles.bright('rdCLI Sandbox')}`);
