 ...
 * checked out in the main worktree), last-commit metadata, and the rdCLI
...
/**
 * Input accepted when registering an existing worktree as a rdCLI project.
 *
...
/**
 * Project view returned after a worktree is opened in rdCLI.
 *
