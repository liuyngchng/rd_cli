...
const platform = mapPlatform(process.env.RDCLI_BUNDLE_PLATFORM || process.platform);
const arch = mapArch(process.env.RDCLI_BUNDLE_ARCH || process.arch);
const version = packageJson.version;
const bundleName = `rdcli-local-server-${version}-${platform}-${arch}.tar.gz`;
