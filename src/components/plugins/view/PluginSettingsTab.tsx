  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-center gap-3 border-t border-border/50 pt-2">
        ...
        <span className="text-xs text-muted-foreground/60">{t('pluginSettings.starter')}</span>
        <span className="text-muted-foreground/20">·</span>
        <span className="text-xs text-muted-foreground/60">{t('pluginSettings.docs')}</span>
      </div>
    </div>
  );
}
