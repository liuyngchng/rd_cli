...
// Hardcoded to Chinese (zh-CN) — ignore localStorage and browser preferences.
...
i18n
  ...
  .init({
    ...
    // Default language — always zh-CN, ignoring localStorage
    lng: FORCED_LANGUAGE,
    ...
    // Detection options — disabled: language is forced to zh-CN
    detection: undefined,
  });

// Force language back to zh-CN if anything tries to change it
i18n.on('languageChanged', (lng) => {
  if (lng !== FORCED_LANGUAGE) {
